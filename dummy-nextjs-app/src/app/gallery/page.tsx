...
export default function Home() {
    ...
    const getImages = async () => {
        // const response = await axios.get("https://cloud.activepieces.com/api/v1/webhooks/3mJSWxflW3cu4MT1Mv09f/sync")
        const response = await axios.get("http://62.146.182.67:1337/list_images")
